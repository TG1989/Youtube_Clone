    ...
    <div
      ...
      <div className="flex gap-4 mt-5">
        <img src={video.channelThumbnail 
          ? video.channelThumbnail[0].url : 'asd'} className= {`w-14 h-14 rounded-full ${isRow && 'hidden'}`} />
        ...
        <div className="text-[#aaa]">
          ...
          ${isRow && 'text-sm gap-1' }`}>
            <p className="line-clamp-1 whitespace-nowrap">{millify(video.viewCount)} views &#183;</p>
